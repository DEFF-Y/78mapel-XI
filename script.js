...
var senen = `----JADWAL SENEN----<br>PJOK<br>GEOGRAFI<br>INFORMATIKA<br>KIMIA`
var selasa = `----JADWAL SELASA----<br>B.INGGRIS<br>PPKN<br>PKWU<br>BIOLOGI<br>SOSIOLOGI`
var rabu = `----JADWAL RABU----<br>PRAMUKA<br>MATEMATIKA<br>B.INDONESIA`
var kamis = `----JADWAL KAMIS----<br>EKONOMI<br>SEJARAH<br>FISIKA<br>AGAMA ISLAM<br>BIMBINGAN KARIR`
...
var about = `ABOUT<br><br>Dev : Daffa <br><br>Cuma modal nyolong di github<br><br>Gw gabisa ngoding`
...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        default:
            setTimeout(() => {
                sendTextMessage("Gwe gabisa lu ajal ngobrol😢<br>Ketik perintah sesuai yg diatas aja dek");
            }, 2000);
            break;
    }
